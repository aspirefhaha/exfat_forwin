...
返 回 值：HANDLE 设备句柄
******************************************************************************/
HANDLE WINAPI OpenUsbDisk(char* AuthorizeKey, 
    const char* pszVID = NULL, 
    const char* pszPID = NULL, 
    BOOL bCanMultiProcess = TRUE);//此参数不用，只是为了兼容旧的版本   
...
返 回     HANDLE 设备句柄
******************************************************************************/
HANDLE WINAPI OpenUsbDiskEx(char* AuthorizeKey, char DriverLetter, 
                         const char* pszVID = NULL, 
                         const char* pszPID = NULL, 
                         BOOL bCanMultiProcess = TRUE);//此参数不用，只是为了兼容旧的版本   
...
返 回 值：BOOL。
******************************************************************************/
BOOL WINAPI CloseUsbDisk(HANDLE handle);
...
返 回 值：BOOL。
******************************************************************************/
BOOL WINAPI ChangeAuthorizeKey(HANDLE handle, char *OldAuthorizeKey, char *NewAuthorizeKey);
...
返 回 值：BOOL。
******************************************************************************/
BOOL WINAPI CheckAuthorizeKey(HANDLE handle, char *AuthorizeKey);
...
返 回 值：BOOL。
******************************************************************************/
BOOL WINAPI ReadPrivateUserSector(HANDLE handle,  
...
返 回 值：BOOL。
******************************************************************************/
BOOL WINAPI WritePrivateUserSector(HANDLE handle, 
                                   DWORD SectoroffsetInBuf,    // Offset sectors in private buf, must be 0,1,2,...,
...
******************************************************************************/
__int64 WINAPI GetHideZoneSize(HANDLE handle); //if return 0, no hide Zone
...
返 回 值：逻辑单元号。
******************************************************************************/
BYTE WINAPI GetHideZoneLun(HANDLE handle, BYTE &Lun);
...
返 回 值：盘符，注意是一个字符，不带"："。
******************************************************************************/
char WINAPI GetHideZoneDriveLetter(HANDLE handle, char &DriveLetter);
...
返 回 值：BOOL。
******************************************************************************/
BOOL WINAPI VerifyUserPassword(HANDLE handle, char *UserPassword);
...
返 回 值：BOOL。
******************************************************************************/
BOOL WINAPI ChangeUserPassword(HANDLE handle, char *OldUserPassword, char *NewUserPassword);
...
返 回 值：BOOL。
******************************************************************************/
BOOL WINAPI MountHideZoneAsDisk(HANDLE handle, BYTE Lun);
...
返 回 值：BOOL。
******************************************************************************/
BOOL WINAPI UnMountHideZoneAsDisk(HANDLE handle, BYTE Lun);
...
******************************************************************************/
BOOL WINAPI IsInHideZone(HANDLE handle, BYTE Lun);
...
******************************************************************************/
BOOL WINAPI IsCdrom(HANDLE handle, char DriveLetter);
...
返 回 值：BOOL
******************************************************************************/
BOOL WINAPI SetDiskProtect(HANDLE handle, BYTE Lun, BOOL bCanRead, BOOL bCanWrite);
...
返 回 值：BOOL
******************************************************************************/
BOOL WINAPI SetDiskProtectEx(HANDLE handle, BYTE Lun, BOOL bCanRead, BOOL bCanWrite);
...
返 回 值：void
******************************************************************************/
void WINAPI LockUsbDisk(HANDLE handle, BYTE Lun, BYTE &LockStatus);
...
返 回 值：void
******************************************************************************/
void WINAPI UnLockUsbDisk(HANDLE handle, BYTE Lun, BYTE &LockStatus);
...
返 回 值：逻辑分区的容量。
******************************************************************************/
__int64 WINAPI GetUsbDiskSize(HANDLE handle, BYTE Lun);
...
返 回 值：BOOL
******************************************************************************/
BOOL WINAPI SetUsbDiskSize(HANDLE handle, DWORD Lun0Size, DWORD Lun1Size, DWORD hZoneSize, DWORD pZoneSize);
...
返 回 值：BOOL
******************************************************************************/
BOOL WINAPI DiskFormat(HANDLE handle, BYTE Lun);//Format Current Logic Partition which has private sectors
...
返 回 值：BOOL
******************************************************************************/
int WINAPI UpdateISOFileOfCDROMDriver(HANDLE handle, BYTE Lun, char* FileName);
...
返 回 值：序列号长度
******************************************************************************/
BYTE WINAPI GetUDiskSerialNumber(HANDLE handle, char *SerialNumber);
...
返 回 值：序列号长度
******************************************************************************/
BOOL WINAPI SetUDiskSerialNumber(HANDLE handle, char *SerialNumber);
...
返 回 值：产品ID
******************************************************************************/
WORD WINAPI GetPID(HANDLE handle, WORD &Pid);
...
返 回 值：产品ID
******************************************************************************/
BOOL WINAPI SetPID(HANDLE handle, WORD PID);
...
返 回 值：厂商ID
******************************************************************************/
WORD WINAPI GetVID(HANDLE handle, WORD &Vid);
...
返 回 值：厂商ID
******************************************************************************/
BOOL WINAPI SetVID(HANDLE handle, WORD VID);
...
返 回 值：产品名称串
******************************************************************************/
char* WINAPI GetProductInfo(HANDLE handle, char* ProductInfo);
...
返 回 值：产品名称串
******************************************************************************/
BOOL WINAPI SetProductInfo(HANDLE handle, char *ProductInfo);
...
返 回 值：厂商信息串
******************************************************************************/
char* WINAPI GetVendorInfo(HANDLE handle, char* VendorInfo);
...
返 回 值：厂商信息串
******************************************************************************/
BOOL WINAPI SetVendorInfo(HANDLE handle, char *VendorInfo);
...
******************************************************************************/
BOOL WINAPI IsHighSpeed(HANDLE handle); //
...
返 回 值：厂商自定义的序列号。
******************************************************************************/
WORD WINAPI GetVendorSerial(HANDLE handle);
...
******************************************************************************/
char* WINAPI GetUDiskLetter(HANDLE handle, DWORD dwMilliseconds);
...
返 回 值：错误代码。
******************************************************************************/
int WINAPI GetError(HANDLE handle = NULL);
...
返 回 值：返回私密区的大小。
******************************************************************************/
__int64 WINAPI GetPrivateZoneSize(HANDLE handle); //if return 0, no private Zone
...
返 回 值：返回私密区的逻辑单元号。
******************************************************************************/
BYTE WINAPI GetPrivateZoneLun(HANDLE handle, BYTE &Lun);
...
******************************************************************************/
BOOL WINAPI IsReadProtect(HANDLE handle, BYTE Lun);
...
******************************************************************************/
BOOL WINAPI IsWriteProtect(HANDLE handle, BYTE Lun);
...
******************************************************************************/
int WINAPI PzCopyFileTo(HANDLE handle, const char* pszFromFullFileName, const char* pszToFileName, BOOL bFailIfExists);
...
返 回 值：成功返回0，失败返回错误码。参见错误值列表
******************************************************************************/
int WINAPI PzCopyFileFrom(HANDLE handle, const char* pszFromFileName, const char* pszToFullFileName);
...
******************************************************************************/
int WINAPI PzDeleteFile(HANDLE handle, const char* pszFileName);
...
******************************************************************************/
HANDLE WINAPI PzFindFirstFile(HANDLE hUsbHandle, const char* pszFindPath, LPWIN32_FIND_DATA lpFindFileData);
...
******************************************************************************/
BOOL WINAPI PzFindNextFile(HANDLE hUsbHandle, HANDLE hFildFileHandle, LPWIN32_FIND_DATA lpFindFileData);
...
******************************************************************************/
BOOL WINAPI PzFindClose(HANDLE hUsbHandle, HANDLE hFindFileHandle);
...
返 回 值：BOOL
******************************************************************************/
BOOL WINAPI PzCreateDir(HANDLE hUsbHandle, const char* pszDir);
...
******************************************************************************/
HANDLE WINAPI PzOpenFile(HANDLE hUsbHandle, const char* pszFileName, BOOL bCreateWhenNotExist);
...
返 回 值：BOOL
******************************************************************************/
BOOL WINAPI PzReadFile(HANDLE hUsbHandle, HANDLE hFile, LPVOID lpBuffer, 
...
返 回 值：BOOL
******************************************************************************/
BOOL WINAPI PzWriteFile(HANDLE hUsbHandle, HANDLE hFile, LPCVOID lpBuffer, 
						DWORD nNumberOfBytesToWrite, LPDWORD lpNumberOfBytesWritten);
...
返 回 值：BOOL
******************************************************************************/
BOOL WINAPI PzCloseFile(HANDLE hUsbHandle, HANDLE hFile);
...
******************************************************************************/
DWORD WINAPI PzSetFilePointer(HANDLE hUsbHandle, HANDLE hFile, LONG lDistanceToMove, DWORD dwMoveMethod);
...
******************************************************************************/
DWORD WINAPI PzGetFileSize(HANDLE hUsbHandle, HANDLE hFile);
...
返 回 值：BOOL，成功返回TRUE，失败返回FALSE。
******************************************************************************/
BOOL WINAPI PzGetRemainSpaceSize(HANDLE hUsbHandle, __int64& dwSize);
...
返 回 值：BOOL，成功返回TRUE，失败返回FALSE。
******************************************************************************/
int WINAPI PzDeleteDir(HANDLE handle, const char*pszDirName);
...
返 回 值：BOOL，成功返回TRUE，失败返回FALSE。
******************************************************************************/
BOOL WINAPI PzMoveFile(HANDLE hUsbHandle, const char* pszSrcName, const char* pszDestName);
...
BOOL WINAPI Login(HANDLE hUsbHandle, const char* szPassword);
BOOL WINAPI Logout(HANDLE hUsbHandle);
...
返 回 值：
******************************************************************************/
void WINAPI GetUID(HANDLE handle, DWORD *pUid, DWORD *pUid0);

void WINAPI PzSetCopyFileProgress(HANDLE handle, FPZCopyFileProgress fpProgress);


BOOL WINAPI RefreshDisk(HANDLE hUsbHandle);
...
返 回 值：如果指定分区为读保护，返回TRUE，否则返回FALSE。
******************************************************************************/
BOOL WINAPI IsReadProtectEx(HANDLE handle, BYTE Lun);
